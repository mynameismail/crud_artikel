...
CREATE TABLE `artikel` (
  ...
  `subjudul` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ringkasan` tinytext COLLATE utf8mb4_general_ci,
  `isi` text COLLATE utf8mb4_general_ci NOT NULL,
  `penulis` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `gambar` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2019-06-21 15:04:21
